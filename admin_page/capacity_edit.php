...
<head>
    ...
    <title>ADMIN CAPACITY EDIT</title>
</head>
<body>
<section class="section is-large">
    <form action="" method="post">
        <!--Field for capacity-->
        <div class="field">
            <label class="label is-medium" for="name">Capaciteit</label>
            <div class="control">
        ...
        <div class="field">
            ...
            <div class="field-body">
                <button class="button is-primary is-medium" type="submit" name="submit">Save</button>
            </div>
        </div>
    </form>
</section>
