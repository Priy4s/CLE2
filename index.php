    ...
    <!--<section class="section is-medium">
                <div class="container is-max-desktop">
                    <div class="box is-max-desktop">
                        <p class="title has has-text-centered">
                            Welcome <?php /*= htmlentities($myName) */?>
                        </p>
                        ...
                        <div class="field is-grouped">
                            <div class="container has-text-centered">
                                <a class="button is-medium" href="read.php">Reserveringen</a>
                            </div>
                            <div class="container has-text-centered">
                                <a class="button is-medium" href="logout.php">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box is-max-desktop">
                    <nav class="level">
                        <div class="level-item has-text-centered">
                            <a class="button is-light" href="">Reserveringen</a>
                        </div>
