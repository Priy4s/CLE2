...
<div class="container px-4">
    ...
    <section class="columns is-centered">
        <div class="column is-10">
            ...
            <form class="column is-6" action="edit.php?id=<?= $daycapacityId ?>" method="post"
                ...
                <div class="field is-horizontal">
                    <div class="field-label is-normal">
                        <label class="label" for="people">Personen</label>
                    </div>
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <input class="input" id="people" type="text" name="new_people"
                                       value="<?php echo isset($inputValues['new_people']) ? $inputValues['new_people'] : ''; ?>"/>
                            </div>
                            <p class="help is-danger">
                                <?php echo isset($errorPeople) ? $errorPeople : ''; ?>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <form action="edit.php?id=<?= $daycapacityId ?>" method="post"
            ...
            <a class="button mt-4" href="index.php">&laquo; Go back to list</a>
        </div>
    </section>
</div>
</body>
