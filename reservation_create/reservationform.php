...
<div class="container px-4">
    ...
    <form method="post" action="">
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="text" name="name" value="<?= htmlspecialchars($valName) ?>">
            </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="email" name="email" value="<?= htmlspecialchars($valEmail) ?>">
            </div>
            <p class="help is-danger">
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="text" name="phone" value="<?= htmlspecialchars($valPhone) ?>">
            </div>
            <p class="help is-danger">
        ...
        <div class="field">
            ...
            <div class="control">
                <textarea class="textarea" name="comment"><?= htmlspecialchars($valComment) ?></textarea>
            </div>
            <p class="help is-danger">
